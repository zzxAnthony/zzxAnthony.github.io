...
if (dailyQuote) {
  const quotes = [
    ...
    ['我喜欢的不是完美的你，是你认真生活时发亮的样子。', '关于喜欢'],
    ['真正的偏爱，是热闹散去以后，还愿意听你慢慢说。', '关于偏爱'],
    ['我们不必时时相爱，但要记得站在彼此这边。', '关于陪伴'],
    ['喜欢是想靠近，爱是靠近以后仍愿意理解。', '关于感情'],
    ['感情里最温柔的事，是不用猜，也不会怕。', '关于安心'],
    ['遇见你以后，普通的星期三也有了值得期待的理由。', '关于心动'],
    ['想和你分享的不是盛大未来，是今天路边很好看的云。', '关于陪伴'],
    ['如果最后没能同行，也谢谢你让那段路有过灯。', '关于告别'],
    ['爱不是把两个人变成一样，是愿意为彼此保留不同。', '关于理解'],
    ['不用每天说想念，愿意回应本身就很浪漫。', '关于回应'],
    ['后来我明白，真诚比技巧更容易让人心动。', '关于真诚'],
    ['你来时像春天，走后我也学会自己种花。', '关于告别'],
    ['喜欢会让人慌张，被坚定选择才让人安心。', '关于选择'],
    ['我想要的浪漫，是每次分享小事时，你都没有觉得无聊。', '关于浪漫'],
    ['成长不是突然想通，是同一件事不再反复为难自己。', '关于成长'],
    ['走慢的日子也在组成你，别只记得那些飞奔的时刻。', '关于成长'],
    ['以前总想证明自己，后来更想安静地完成自己。', '关于自己'],
    ['没有赶上的春天，可以在自己的季节里重新开花。', '关于成长'],
    ['把遗憾放在过去，把力气留给下一次出发。', '关于出发'],
    ['你可以回头看，但别在那里住太久。', '关于过去'],
    ['有些坎不是跨过去的，是走远以后慢慢变小的。', '关于成长'],
    ['真正的长大，是允许别人误解，也不急着解释所有事。', '关于长大'],
    ['日子没有突然变好，是你慢慢有了接住它的力气。', '关于成长'],
    ['今天的笨拙，是明天熟练之前必须经过的一小段路。', '关于练习'],
    ['不要因为暂时看不到花，就怀疑自己种下的种子。', '关于坚持'],
    ['和昨天的自己和解，才能给明天腾出位置。', '关于和解'],
    ['你不需要一直坚强，能照顾好疲惫也算成长。', '关于自己'],
    ['世界催你快一点，你可以先确认自己要去哪里。', '关于方向'],
    ['失去方向时，先把眼前的一步走稳。', '关于前进'],
    ['接受平凡以后，反而更敢认真地做梦。', '关于梦想'],
    ['有些答案来得晚，是因为你要先长成能听懂它的人。', '关于答案'],
    ['变好不是把自己推倒重来，是一点点修正，一点点喜欢自己。', '关于成长'],
  ];
